        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <GlassyCard className="p-6">
              ...
              <p className="mt-1 text-slate-300/90">Docs and slides are parsed and embedded.</p>
            </GlassyCard>
            <GlassyCard className="p-6">
            ...
            <GlassyCard className="p-6">
              ...
              <p className="mt-1 text-slate-300/90">Guided explanations and practice—not solutions.</p>
            </GlassyCard>
          </div>
        </div>
      </section>
